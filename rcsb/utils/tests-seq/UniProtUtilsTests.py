...
class UniProtUtilsTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.__unpIdList2 = ['P29490', 'P29496', 'P29498', 'P29499', 'P29503', 'P29506', 'P29508', 'P29509', 'P29525',
                             'P29533', 'P29534', 'P29547',
                             'P29549', 'P29555', 'P29557', 'P29558', 'P29559', 'P29563', 'P29588', 'P29589', 'P29590',
                             'P29597', 'P29599', 'P29600',
                             'P29602', 'P29603', 'P29617', 'P29678', 'P29691', 'P29715', 'P29717', 'P29723', 'P29724',
                             'P29736', 'P29741', 'P29745',
                             'P29748', 'P29749', 'P29752', 'P29758', 'P29768', 'P29803', 'P29808', 'P29813', 'P29827',
                             'P29830', 'P29837', 'P29838',
                             'P29846', 'P29848', 'P29882', 'P29894', 'P29898', 'P29899', 'P29929', 'P29946', 'P29957',
                             'P29960', 'P29965', 'P29966',
    ...
    def testBatchFetch(self):
        ...
        try:
            ...
            if retD and self.__export:
                for rId in retD:
                    self.__mU.doExport(os.path.join(self.__workPath, rId + '.json'), retD[rId], format='json', indent=3)
        except Exception as e:
            logger.exception("Failing with %s" % str(e))
            self.fail()
                ...
                if retD:
                    ...
                    for (eId, eDict) in retD.items():
                        if 'db_isoform' in eDict and eId == id:
                            logger.debug("------ sequence database code  %s has key db_isoform:  %r" % (
                                eId, eDict['db_isoform']))
                            logger.debug("------ sequence database code  %s sequence length %d" % (
